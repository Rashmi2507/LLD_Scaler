...
public class Client {
    public static void main(String[] args) {
        ...
        sevenMMBullet.setBulletType(BulletType.SENVEN_MM);
        bulletRegistry.registerBullet(BulletType.SENVEN_MM, sevenMMBullet);
        ...
        System.out.println("Total bullets created");
    }
}
